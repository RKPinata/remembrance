# Sources — remembrance skill

| #   | Source             | Path          | Trust     | Confidence | Contribution                                                                                                          |
| --- | ------------------ | ------------- | --------- | ---------- | --------------------------------------------------------------------------------------------------------------------- |
| 1   | remembrance README | `./README.md` | canonical | high       | All API signatures, scope model, storage design, migration strategy, failure modes, security model, use case patterns |
...
| Skill name: `remembrance`                                       | adopted | Matches package name exactly; clear trigger match                                    |
